...
const int get_MAX_RESULTSET_SIZE();
const char *get_BRS_SERVER_ID();
const char *get_BRS_SERVER_PORT();
const char *get_ML_PRED_SERVER_IP();
const char *get_ML_PRED_SERVER_PORT();
const char *get_ML_TRAINING_SERVER_IP();
const char *get_ML_TRAINING_SERVER_PORT();
...
unsigned long subTime(long nsec);
void sleep_us(unsigned long nsec);

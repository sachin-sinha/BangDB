...
int main(int argc, char *argv[])
{
	if(argc < 4)
	{
		...
		printf("----------------------------------------------------------------------------\n");
		printf("\nRunning the default test with 50 connections, put and get 200000 items\n");
		bangdb_server_bench(50, 200000, (char*)"all", 0);
		exit(0);
	}
	...
	bangdb_server_bench(atoi(argv[1]), atoi(argv[2]), argv[3], factor);
